 ...
 */
class Version20170206162438 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE author CHANGE firstname firstname LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE author CHANGE firstname firstname VARCHAR(500) DEFAULT NULL COLLATE utf8_unicode_ci');
