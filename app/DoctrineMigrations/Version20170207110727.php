 ...
 */
class Version20170207110727 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE country CHANGE pays country VARCHAR(45) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE country CHANGE country pays VARCHAR(45) DEFAULT NULL COLLATE utf8_unicode_ci');
    }
}
